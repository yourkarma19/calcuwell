    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          relationship between **Voltage (V)**, **Current (I)**, **Resistance
          (R)**, and **Power (P)** in a circuit. Just enter any two values, and
          the calculator will instantly find the other two for you.
        </p>
        <h3>How to Use the Calculator</h3>
        <ol>
          <li>
            First, select the value you want to solve for (e.g., Voltage).
          </li>
          <li>Enter any two of the other known values.</li>
        </ol>
        <p>
          The calculator will automatically show the correct result. This is
          useful for designing and testing circuits.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Ohm&apos;s Law is a basic rule in electronics that connects
              voltage, current, and resistance. The formula is `V = I × R`. It
              says that the voltage across a component is equal to the current
              flowing through it multiplied by its resistance.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              the value you want to find, and the other two will show you the
              calculation:
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              calculator can also solve for power using any two of the other
              values.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              and find problems in electronic devices.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
