  ...
  return (
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          The result of the conversion will be displayed instantly. Use the swap
          button to quickly reverse the units.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              metric system. It is the most widely used system of measurement.
              This calculator uses SI base units (like the meter for length) to
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Temperature conversion does not use a simple multiplication
              factor. It uses specific formulas to convert between Celsius,
              Fahrenheit, and Kelvin. This is because their scales have
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              The **Metric system** is a decimal-based system used by most of
              the world, with units like meters, grams, and liters. The
              **Imperial system** is mainly used in the United States and
              includes units like feet, pounds, and gallons. This converter
              allows for easy translation between both systems.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
