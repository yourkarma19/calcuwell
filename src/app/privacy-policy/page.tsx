...
export const metadata: Metadata = {
  ...
  description:
    "Read the privacy policy for CalcPro. We are committed to protecting your data and privacy when you use our free online calculator tools. We do not store your calculation data.",
  alternates: {
  ...
  return (
    <main className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none text-lg">
        ...
        <p>
          This page explains how we handle your information when you use our
          website, calcpro.online (the &quot;Service&quot;).
        </p>

        <p>
          By using our Service, you agree to this policy. We use the information
          we collect to improve our tools. We will not share your data with
          anyone except as described here.
        </p>

        <h2>Information We Collect</h2>
        <p>
          We respect your privacy. Our calculators do not require you to provide
          any personal information to use them. Any data you enter into a
          calculator is processed in your browser and is not stored on our
          servers.
        </p>

        <h2>Website Analytics</h2>
        <p>
          Like most websites, we collect &quot;Log Data&quot; that your browser
          sends. This may include your device&apos;s IP address, browser type,
          and which pages you visit. This data helps us understand how our
          Service is being used so we can improve it. We use Google Analytics
          for this purpose.
        </p>
...
<<<<<<< HEAD
        ...
        <ul>
          ...
          <li>
            ...
            third-party vendor&apos;s use of cookies for personalized
            advertising by visiting www.aboutads.info/choices.
          </li>
        </ul>
        <p>
          If you have not opted out of third-party ad serving, the cookies of
          other third-party vendors or ad networks may also be used to serve ads
          on your site.
        </p>
=======
                <h2>Advertising and Cookies</h2>
...
>>>>>>> 3312b78 (I see this error with the app, reported by NextJS, please fix it. The er)
        ...
        <p>
          Our website may link to other sites. If you click a third-party link,
          you will be taken to their website. We do not control those sites, so
          we suggest you review their privacy policies.
        </p>

        <h2>Policy Updates</h2>
        <p>
          We may update this policy. Please check this page for the latest
          version. Changes are effective as soon as they are posted here.
        </p>
