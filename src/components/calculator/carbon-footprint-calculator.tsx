...
export default function CarbonFootprintCalculator() {
  ...
  const [transportMode, setTransportMode] = usePersistentState<
    keyof typeof emissionFactors.transport
  >("cf-transport", "car_gasoline");
  const [electricity, setElectricity] = usePersistentState(
    "cf-electricity",
    150,
  ); // kWh per month
  const [diet, setDiet] = usePersistentState<keyof typeof emissionFactors.diet>(
    "cf-diet",
    "medium_meat",
  );
  ...
  const totalFootprint = useMemo(() => {
    const transportEmissions =
      distance * 30 * emissionFactors.transport[transportMode]; // monthly
    ...
    const totalMonthlyKg =
      transportEmissions + electricityEmissions + dietEmissions;
    ...
    <div className="lg:col-span-3 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Get a rough estimate of your monthly carbon footprint based on your
            daily commute, energy use, and diet.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={transportMode}
                onValueChange={(v) =>
                  setTransportMode(v as keyof typeof emissionFactors.transport)
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <div className="space-y-2">
            ...
            <Select
              value={diet}
              onValueChange={(v) =>
                setDiet(v as keyof typeof emissionFactors.diet)
              }
            >
              <SelectTrigger>
                <SelectValue />
      ...
      <Card>
        <CardHeader>
          <CardTitle>Your Estimated Footprint</CardTitle>
        </CardHeader>
        <CardContent className="text-center">
          ...
          <p className="text-xs text-muted-foreground mt-4">
            Average is ~1.5 tonnes per month.
          </p>
        </CardContent>
      </Card>
      <Card>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                common daily activities like travel, energy consumption, and
                diet.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                There are many ways to reduce your footprint. Consider using
                public transport, walking, or cycling instead of driving. Reduce
                energy consumption at home by using energy-efficient appliances
                and turning off lights. Reducing meat consumption, especially
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Calculating a precise carbon footprint is very complex. It
                depends on factors like your local power grid&apos;s energy
                sources, the specific model of your car, and the supply chains
                of the food you eat. This tool uses averages to provide a
                general idea of your impact.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </CardContent>
