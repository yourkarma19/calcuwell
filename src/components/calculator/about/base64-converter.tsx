    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          and text into a safe, text-based format. This format can be reliably
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Base64 is an encoding system that turns binary data into a set of
              64 ASCII characters. This makes it safe for use in text-based
              systems like email (MIME) or for embedding data directly into HTML
              or CSS files. It prevents data from being changed or corrupted
              during transfer.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              represent data, not secure it. Anyone can decode a Base64 string
              back to its original form, so it offers no privacy. For security,
              you should use an encryption algorithm like AES.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              a web page&apos;s HTML or CSS code. The file data is encoded using
              Base64. This can reduce the number of HTTP requests a browser
              needs to make. This can help speed up page load times for very
              small files.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
