    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          transport, and use oxygen during intense exercise. A higher VO₂ max
          usually means better cardiovascular health and greater endurance. It
          is considered the gold standard for measuring cardiorespiratory
          fitness.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              a useful starting point, not a definitive medical value.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionTrigger>How can I improve my VO₂ max?</AccordionTrigger>
            <AccordionContent>
              You can significantly improve your VO₂ max with consistent and
              structured aerobic exercise. High-Intensity Interval Training
              (HIIT) is particularly effective. This involves short bursts of
              intense effort (working at 80-90% of your maximum heart rate)
              followed by brief recovery periods. Long, steady-state cardio
              sessions, like running or cycling, also contribute to improving
              your aerobic base and VO₂ max over time.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
