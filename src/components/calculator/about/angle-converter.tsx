    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          common units of angle measurement: <strong>degrees</strong> and{" "}
          <strong>radians</strong>. This tool provides instant, accurate
          conversions, eliminating the need for manual calculations and helping
        ...
        <p>
          ...
          value. Use the swap button to easily reverse the direction of the
          conversion.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <p>
                <strong>Degrees (°)</strong> are the most common unit for
                measuring angles in everyday life, with a full circle containing
                360°. Each degree is a 1/360th part of a full rotation.
              </p>
              <p>
                <strong>Radians (rad)</strong> are the standard unit of angular
                measure in mathematics and physics. A radian is defined by the
                arc of a circle: one radian is the angle at the center of a
                circle where the arc length is equal to the radius. A full
                circle contains 2π radians.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>
              Why do mathematicians and physicists prefer radians?
            </AccordionTrigger>
            <AccordionContent>
              Radians are preferred in higher-level mathematics because they
              simplify many important formulas, especially in calculus and
              trigonometry. Because radians are directly related to the radius
              of a circle, they create more natural and elegant equations
              without arbitrary constants (like the number 360).
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <p>
                The conversion is based on the relationship that 180° = π
                radians.
              </p>
