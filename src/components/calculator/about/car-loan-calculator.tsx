    ...
    return (
        <Card>
            ...
            <ol>
              ...
              <li>Input your **Down Payment** and the **Trade-in Value** of your old vehicle, if any.</li>
              <li>Adjust the **Interest Rate** and **Loan Tenure** (in years) to match the loan offer.</li>
            </ol>
