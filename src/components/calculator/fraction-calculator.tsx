      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>
            ...
            multiplying, and dividing fractions. It also automatically
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                <p>
                  ...
                  denominators can divide into. Once both fractions have the
                  same denominator, you can add their numerators. For example,
                  to add 1/2 + 1/4, you convert 1/2 to 2/4. Then, you add the
                  numerators: 2/4 + 1/4 = 3/4.
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                <p>
                  To simplify a fraction, you find the largest number that
                  divides both the numerator and the denominator evenly. This
                  number is called the Greatest Common Divisor (GCD). You then
                  divide both the top and bottom numbers by the GCD. For
                  example, for the fraction 12/16, the GCD is 4. Dividing both
                  parts by 4 gives you the simplified fraction 3/4.
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                <p>
                  ...
                  than the bottom number (e.g., 3/4). An **improper fraction**
                  is one where the top number is larger than or equal to the
                  bottom number (e.g., 5/4). Improper fractions can also be
                  written as mixed numbers (e.g., 5/4 is the same as 1 ¼).
                </p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
