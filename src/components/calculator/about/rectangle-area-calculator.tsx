    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          of a rectangle. Whether you&apos;re a student learning geometry, a
          homeowner planning a room layout, or a contractor estimating
          materials, this calculator provides instant and accurate measurements
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              It&apos;s calculated by multiplying its length by its width. The
              formula is: `Area = Length × Width`. The result is expressed in
              square units (e.g., square meters).
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              The perimeter is the total distance around the outside of the
              rectangle. It&apos;s found by adding the lengths of all four
              sides. Since opposite sides are equal, the formula is: `Perimeter
              = 2 × (Length + Width)`.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              are equal. To calculate the area or perimeter of a square, simply
              enter the same value for both the length and the width.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              <ul className="list-disc pl-5 mt-2">
                <li>
                  Figuring out how much paint or carpet is needed for a room.
                </li>
