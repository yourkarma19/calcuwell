    ...
    <div className="lg:col-span-3 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Convert a mixed number (a whole number and a fraction) into an
            improper fraction. More operations coming soon.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div
            role="group"
            aria-labelledby="mixed-number-label"
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                which would be 5/2. They are used extensively in cooking,
                construction, and other hands-on fields where precise
                measurements that are not whole units are common.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>
                Step-by-Step Guide: How to Convert an Improper Fraction to a
                Mixed Number
              </AccordionTrigger>
              <AccordionContent>
                To convert an improper fraction (where the numerator is larger
                than the denominator) to a mixed number, you simply perform the
                division. Divide the numerator by the denominator. The quotient
                of the division becomes the whole number part of the mixed
                number. The remainder of the division becomes the new numerator,
                and the denominator stays the same. For example, to convert 7/3,
                you divide 7 by 3. This gives you 2 with a remainder of 1. So,
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                The easiest and most reliable way to add or subtract mixed
                numbers is to first convert them all into improper fractions.
                Once you have two improper fractions, you find a common
                denominator for both. After they share a common denominator, you
                can perform the addition or subtraction on the numerators.
                Finally, you can convert the resulting improper fraction back to
                a mixed number if needed. This method avoids potential errors
                when borrowing from the whole number in subtraction.
              </AccordionContent>
            </AccordionItem>
