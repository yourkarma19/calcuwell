    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          you&apos;re a student tackling geometry homework, an engineer
          designing a structure, or a professional needing a quick calculation,
          this tool simplifies the process. It allows you to find the values of
          sine, cosine, tangent, and their inverse functions (arcsin, arccos,
        ...
        <ol>
          <li>
            ...
            dropdown menu (e.g., sin, cos, asin).
          </li>
          <li>
            Enter the **Value** (either an angle for sin/cos/tan, or a ratio for
            asin/acos/atan).
          </li>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Inverse trigonometric functions (like asin, acos, atan, often
              written as sin⁻¹, cos⁻¹, tan⁻¹) are used to find the angle when
              you know the ratio of the sides. For example, if you know that the
              sine of an angle is 0.5, you can use arcsin (sin⁻¹) to find that
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              A full circle is 360 degrees or 2π radians. It&apos;s crucial to
              use the correct unit for your calculations, as using the wrong one
              will lead to incorrect results. Most advanced mathematical and
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              Trigonometry is used in many fields, including astronomy (to
              measure distances to stars), navigation (GPS systems), engineering
              (to build structures), physics (to analyze waves), and video game
              development (to control object movement and camera angles).
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
