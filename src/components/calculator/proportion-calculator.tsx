...
export default function ProportionCalculator() {
  ...
  const [solveFor, setSolveFor] = usePersistentState<"a" | "b" | "c" | "d">(
    "proportion-solve",
    "d",
  );
  ...
  const getInputProps = (field: "a" | "b" | "c" | "d") => {
    ...
    switch (field) {
      case "a":
        [value, setter] = [valA, setValA];
        break;
      case "b":
        [value, setter] = [valB, setValB];
        break;
      case "c":
        [value, setter] = [valC, setValC];
        break;
      case "d":
        [value, setter] = [valD, setValD];
        break;
    }
    ...
    return {
      ...
      onClick: () => setSolveFor(field),
      "aria-label": `Value ${field.toUpperCase()}`,
    };
  };
    ...
    <div className="lg:col-span-3 space-y-6">
      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>
            Our **Proportion Calculator** is a powerful tool for solving
            equations involving two equivalent ratios. A proportion is a
            statement that two fractions are equal, written as A/B = C/D. This
            calculator allows you to find the missing value in the equation,
            making it invaluable for students, cooks, engineers, and anyone who
            needs to scale quantities.
          </p>
          ...
          <p>
            The tool uses cross-multiplication to deliver an instant and
            accurate answer.
          </p>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                <p>
                  ...
                  second (A × D) and set it equal to the product of the other
                  two (B × C). This gives you the equation A × D = B × C. From
                  there, you can use simple algebra to solve for the unknown
                  variable.
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                <p>
                  Proportions are used everywhere in daily life, often without
                  us even realizing it. Common examples include:
                </p>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                <p>
                  ...
                  <strong>proportion</strong> is an equation that states that
                  two ratios are equal (e.g., A/B = C/D). In essence, a
                  proportion is an equation built from two equal ratios. You
                  can&apos;t have a proportion without ratios.
                </p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
