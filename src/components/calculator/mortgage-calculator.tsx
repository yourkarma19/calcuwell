...
export default function MortgageCalculator({ setChildProps = (props: Record<string, unknown>) => {}, calculatorName }: { setChildProps?: (props: Record<string, unknown>) => void, calculatorName: string }) {
