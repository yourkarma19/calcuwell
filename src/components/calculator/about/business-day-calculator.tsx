    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          find a future or past date by adding or subtracting a specific number
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>
              What is the difference between a day and a business day?
            </AccordionTrigger>
            <AccordionContent>
              A regular day is any day of the week, including weekends. A
              business day, also known as a working day, specifically refers to
              a typical day of work, which is usually Monday through Friday.
              This calculator automatically skips Saturdays and Sundays in its
              calculation.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              This calculation is critical for business operations, especially
              in logistics, finance, and legal contracts. It helps set accurate
              expectations for delivery dates, payment schedules, and project
              deadlines that must fall on official working days to be met.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              they can vary by country, state, and even by industry. To get the
              most accurate date, you would need to manually add extra days for
              any public holidays that fall within your calculated period.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
