    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>
            Select your gender, then enter your waist and hip measurements in
            centimeters. To measure correctly:
          </p>
          <ul>
            <li>
              **Waist:** Measure at the narrowest point, usually just above your
              belly button.
            </li>
