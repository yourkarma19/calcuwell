...
export default function WeddingBudgetCalculator() {
  ...
  const [cateringPerPlate, setCateringPerPlate] = usePersistentState(
    "wedding-catering",
    75,
  );
  const [photography, setPhotography] = usePersistentState(
    "wedding-photo",
    3000,
  );
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Estimate the total cost of your wedding by filling in the details
            below.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="catering">Catering (per plate)</Label>
              <Input
                id="catering"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="dress">Dress &amp; Attire</Label>
              <Input
                id="dress"
                type="number"
                value={dress}
            ...
            <div className="space-y-2">
              <Label htmlFor="decor">Decorations</Label>
              <Input
                id="decor"
                type="number"
                value={decor}
                onChange={(e) => setDecor(Number(e.target.value))}
              />
            </div>
            <div className="space-y-2">
