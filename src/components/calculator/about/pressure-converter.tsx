    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          Pressure is defined as the force applied perpendicular to the surface
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              The standard SI (International System of Units) unit for pressure
              is the **Pascal (Pa)**. One pascal is a very small amount of
              pressure, defined as one newton of force per square meter. Because
              it&apos;s so small, it&apos;s often more convenient to use
