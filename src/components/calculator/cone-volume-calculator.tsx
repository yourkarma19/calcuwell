    ...
    <div className="lg:col-span-3 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter the radius and height of the cone to find its volume and
            surface area.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-muted p-4 rounded-lg text-center">
            ...
            <p className="text-2xl font-semibold">
              {slantHeight.toLocaleString(undefined, {
      ...
      <Card>
        <CardHeader>
          <CardTitle>About the Cone Calculator</CardTitle>
        </CardHeader>
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>
            The Cone Calculator is a useful tool for anyone working with 3D
            shapes. It helps find a cone&apos;s key properties, such as its
            volume, slant height, and surface area. This calculator is perfect
            for students and professionals who need quick and accurate
            calculations.
          </p>
          ...
          <ol>
            <li>
              Enter the <strong>Radius</strong> of the cone&apos;s circular
              base.
            </li>
            <li>
              Enter the perpendicular <strong>Height</strong> of the cone (from
              the base to the tip).
            </li>
          </ol>
          <p>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                with the same base and height. The formula is `V = (1/3) * π *
                r² * h`.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                ...
                not the same as the perpendicular height. It is needed to
                calculate the surface area of the cone&apos;s side. You can find
                it using the formula: `s = √(r² + h²)`.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                The total surface area of a cone is the area of its circular
                base (`π * r²`) plus its side surface area (`π * r * s`), where
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                ...
                common type. It means the tip is directly above the center of
                the circular base. An oblique cone is one where the tip is not
                centered.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
