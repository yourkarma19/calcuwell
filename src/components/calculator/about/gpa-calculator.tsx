...
export default function AboutGpaCalculator() {
  return (
    <Card>
      <CardHeader>
        <CardTitle as="h2">About the GPA Calculator</CardTitle>
      </CardHeader>
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          Enter your courses, the grade you received, and the number of credits
          for each course. The calculator will then compute your GPA for you.
        </p>
        <h3>GPA FAQs</h3>
