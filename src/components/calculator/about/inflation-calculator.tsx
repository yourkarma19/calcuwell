  ...
  return (
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          Our Inflation Calculator is a financial tool that helps you understand
          the impact of inflation on your money over time. It shows you how the
          purchasing power of a certain amount of currency changes between two
        ...
        <p>
          The calculator will show you what the initial amount would be worth in
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              is falling. For example, if the inflation rate is 2% per year,
              then a ₹100 item will cost ₹102 next year. Your money buys less
              than it did before.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              end years to find the total percentage change in purchasing power.
              It then applies this change to your initial amount.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              The inflation data used in this calculator is based on the
              Consumer Price Index (CPI), which is a measure that examines the
              weighted average of prices of a basket of consumer goods and
              services, such as transportation, food, and medical care. It is
              one of the most common measures of inflation.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              The inflation rates used in this calculator are based on
              historical data and are for informational purposes. The final,
              official rates for the current year are typically published after
              the year ends.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
