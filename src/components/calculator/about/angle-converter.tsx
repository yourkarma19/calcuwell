    ...
    return (
        <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
                <p>The Angle Converter is a simple yet essential tool for students, engineers, and scientists who need to switch between the two most common units of angle measurement: <strong>degrees</strong> and <strong>radians</strong>. This tool provides instant, accurate conversions, eliminating the need for manual calculations and helping to prevent errors in technical work.</p>
