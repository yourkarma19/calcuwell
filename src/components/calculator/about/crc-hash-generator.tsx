    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          It&rsquo;s a fast way to check if data has been accidentally changed
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              CRC-32 is very common because it&rsquo;s fast and effective.
              You&rsquo;ll find it in:
