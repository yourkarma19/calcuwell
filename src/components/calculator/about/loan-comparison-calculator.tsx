    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          Calculator is a tool designed to help you make an informed decision by
          putting two loan offers side-by-side. By showing the differences in
          monthly payments, total interest, and overall cost, you can easily see
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <p>
                Not always. A lower EMI is easier on your monthly budget, but it
                often comes with a longer loan term. This means you could pay
                much more in total interest. This tool helps you see that
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              <p>
                A lot. Even a small difference of 0.5% in the interest rate can
                lead to large savings over a long term, especially for big loans
                like a home loan. Use this tool to see the exact difference in
                total interest paid between two rates.
              </p>
            </AccordionContent>
          </AccordionItem>
