    ...
    <div className="lg:col-span-3 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Calculate the volume and surface area of a cylinder by providing its
            radius and height.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-muted p-4 rounded-lg text-center">
            ...
            <p className="font-semibold text-2xl">
              {lateralArea.toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}
            </p>
          </div>
          <div className="bg-muted p-4 rounded-lg text-center">
            ...
            <p className="font-semibold text-2xl">
              {baseArea.toLocaleString(undefined, { maximumFractionDigits: 2 })}
            </p>
          </div>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>
            ...
            geometric properties of a cylinder. By simply providing the radius
            and height, you can instantly find the volume (the space it can
            hold) and the surface area (the total area of its exterior). This is
            useful for everything from calculating the capacity of a tank to
            estimating the amount of material needed to construct a cylindrical
            object.
          </p>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                circular base by its height. The formula is `Volume = π * r² *
                h`, where &apos;r&apos; is the radius of the base and
                &apos;h&apos; is the height. This tells you the total capacity
                of the cylinder.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Cylinder calculations are essential in many fields. Engineers
                use them to design pipes, tanks, and pillars. In manufacturing,
                they are used to determine the volume of cans and containers.
                They are also fundamental in physics for problems involving
