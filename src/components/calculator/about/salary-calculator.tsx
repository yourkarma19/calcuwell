    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <ol>
          ...
          <li>
            Enter any other regular **Deductions** per pay period (e.g., for
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              **Gross Salary** is the total amount of money an employee earns
              before any taxes and other deductions are subtracted. **Net
              Salary** (or take-home pay) is the amount of money an employee
              receives after all deductions have been taken out.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              intended for estimation purposes.
            </AccordionContent>
          </AccordionItem>
