            ...
            <CardContent className="prose dark:prose-invert max-w-none">
                ...
                <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-2">
                        ...
                        <AccordionContent>
                           To convert a mixed number to an improper fraction, you multiply the whole number by the denominator and then add the numerator. This result becomes the new numerator, and the denominator stays the same. For example, for 2 ½, you calculate (2 * 2) + 1 = 5, so the improper fraction is 5/2. This process effectively combines the whole parts into the fraction, expressing the total value as a single fraction.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                     ...
                     <AccordionItem value="item-4">
                        ...
                        <AccordionContent>
                            An improper fraction is a fraction where the numerator (the top number) is greater than or equal to the denominator (the bottom number). For example, 5/4 or 3/3 are improper fractions. They represent a value of 1 or more. They can always be converted into a mixed number or a whole number, which often makes them easier to interpret in a real-world context.
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </CardContent>
