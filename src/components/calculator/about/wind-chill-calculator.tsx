  ...
  return (
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <ol>
          <li>
            Select your preferred temperature and speed units (°F/mph or
            °C/kmh).
          </li>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Wind chill is not the actual temperature of the air, but rather a
              measure of the rate of heat loss from the body due to the combined
              effect of cold and wind. The faster the wind blows, the faster it
              carries heat away from your body, making it feel colder than it
              actually is.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              which was developed by a joint effort between the US National
              Weather Service and Environment Canada. This formula is considered
              the most accurate standard for human exposure.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              negligible and the &quot;feels like&quot; temperature is
              essentially the same as the actual air temperature.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
