...
export default function AboutVatGstCalculator() {
  return (
    <Card>
      <CardHeader>
        <CardTitle as="h2">About the VAT & GST Calculator</CardTitle>
      </CardHeader>
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        />
        <p>
          Our VAT / GST Calculator lets you quickly add or remove a sales tax
          from a price. This makes it easy to see the pre-tax cost or the final
          gross amount. This is perfect for checking receipts or creating
          invoices.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <p>
                ...
                <strong>VAT (Value-Added Tax)</strong> and{" "}
                <strong>GST (Goods and Services Tax)</strong> are both forms of
                consumption tax. The name simply differs by country.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>
              How do you calculate tax from a gross price?
            </AccordionTrigger>
            <AccordionContent>
              <p>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <p>
                Businesses need to separate the net price and the tax amount for
                accounting and tax filing. This tool makes it easy to generate
                accurate invoices and keep financial records straight.
              </p>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
