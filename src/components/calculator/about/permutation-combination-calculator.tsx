    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          subset of items can be selected from a larger set. The key difference
          between the two is whether the order of selection matters. This tool
          ...
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <p>
                ...
                **Permutation** when the order of selection is important (e.g.,
                arranging books on a shelf, 1st/2nd/3rd place winners). Use a
                **Combination** when the order of selection does not matter
                (e.g., picking a team, choosing pizza toppings).
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              <p className="mt-2">
                ...
                permutation formula divided by `r!`, which removes the different
                orderings.
              </p>
            </AccordionContent>
          </AccordionItem>
