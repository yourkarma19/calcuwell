    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          the rate at which work is done or energy is transferred. This
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              The **Watt (W)** is the standard unit of power in the
              International System of Units (SI). One watt is defined as one
              joule of energy per second. It is commonly used to measure the
              output of electrical devices, like light bulbs and appliances. A
              **kilowatt (kW)** is simply 1,000 watts.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>What is Horsepower?</AccordionTrigger>
            <AccordionContent>
              **Horsepower (hp)** is an older unit of power that is still widely
              used, especially in the automotive industry to describe the power
              output of engines. There are different types of horsepower, but
              the most common, mechanical horsepower, is equivalent to
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              the capacity to do work (measured in joules or kWh), while
              **Power** is the rate at which energy is used (measured in watts
              or joules per second). For example, a 100-watt light bulb uses 100
              joules of energy every second it is on.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
