...
export default function ColorConverter() {
  ...
  const { rgb, hsl } = useMemo(() => {
    ...
    if (!validHex)
      return { rgb: { r: 0, g: 0, b: 0 }, hsl: { h: 0, s: 0, l: 0 } };
    ...
    <div className="lg:col-span-3 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Convert between HEX, RGB, and HSL color formats. Edit any value to
            see the others update in real-time.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col items-center gap-4">
            ...
            <div
              className="w-32 h-32 rounded-full border-4 border-card"
      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>
            Our **Color Code Converter** is an essential utility for web
            designers, developers, and digital artists. It provides a seamless
            way to translate colors between three of the most common web color
            formats: **HEX**, **RGB**, and **HSL**. By allowing real-time,
            two-way conversion, this tool helps you find the perfect shade and
            ensures consistency across your projects.
          </p>
          <h3>How to Use the Calculator</h3>
          <ol>
            <li>
              Enter a color value in any of the three formats (HEX, RGB, or
              HSL).
            </li>
            <li>
              As you type, the other two formats will update instantly to
          ...
          <p>
            This dynamic conversion makes it easy to experiment with color
            values and find the exact code you need for your CSS, design
            software, or other digital media.
          </p>
          ...
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionContent>
                <p className="mb-2">
                  **HEX (Hexadecimal)** is a six-digit code (e.g., `#FF5733`)
                  ...
                  color. It&rsquo;s the most common format used in web design.
                </p>
                <p className="mb-2">
                  **RGB (Red, Green, Blue)** is an additive color model where
                  red, green, and blue light are combined to create a broad
                  array of colors. Each value ranges from 0 to 255 (e.g.,
                  `rgb(255, 87, 51)`).
                </p>
                <p>
                  **HSL (Hue, Saturation, Lightness)** represents color in a
                  more human-intuitive way. **Hue** is the color itself (0-360
                  degrees), **Saturation** is the color&rsquo;s intensity
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                ...
                is often preferred by designers because it&rsquo;s more intuitive
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger>
                What does the &ldquo;alpha&rdquo; value in RGBA or HSLA mean?
              </AccordionTrigger>
              <AccordionContent>
                The &rsquo;A&rsquo; stands for Alpha, which represents the opacity
