    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li>
            <strong>Interior Design:</strong> Planning furniture placement and
            room layouts.
          </li>
          <li>
            <strong>DIY Home Projects:</strong> Measuring for flooring,
            wallpaper, or framing.
          </li>
          <li>
            <strong>Gardening &amp; Landscaping:</strong> Laying out garden
            beds, pathways, or fencing.
          </li>
        </ul>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              The easiest way is to convert both measurements entirely into
              inches, multiply them, and then convert the result back to feet
              and inches. This calculator handles that conversion for you. Note
              that multiplying two length measurements results in an area
              (square inches).
            </AccordionContent>
          </AccordionItem>
