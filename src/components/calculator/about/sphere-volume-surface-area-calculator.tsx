    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          measurement: its radius. This calculator is ideal for students
          learning 3D geometry, engineers, designers, and anyone who needs to
          quickly find the volume or surface area of a spherical object. It
          eliminates manual calculations and provides instant, accurate results.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              astronomers use them to estimate the volume of planets, engineers
              use them to design ball bearings and spherical tanks, and
              meteorologists use them to model weather patterns on a global
              scale.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              the sphere to any point on its surface. The{" "}
              <strong>diameter (d)</strong> is the distance straight through the
              center of the sphere, from one side to the other. The diameter is
              always twice the length of the radius (d = 2r).
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
