        ...
        <CardContent className="prose dark:prose-invert max-w-none">
            ...
            <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                        <p>The <strong>mean</strong> is the arithmetic average of all numbers in a data set (the sum of the numbers divided by the count). The <strong>median</strong> is the middle value when the data is sorted in ascending order. The <strong>mode</strong> is the number that appears most frequently in the set.</p>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                    <AccordionTrigger className="font-semibold">When should I use mean vs. median?</AccordionTrigger>
                    <AccordionContent>
                        <p>Use the <strong>mean</strong> for data that is symmetrically distributed (like test scores or heights), where there are no extreme outliers. Use the <strong>median</strong> for skewed data, such as income levels or house prices, because it isn't affected by a few extremely high or low values. The median gives a better sense of the "typical" value in such cases.</p>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                       <ul className="list-disc pl-5">
                            <li><strong>Mean:</strong> Add up all the numbers and divide by how many numbers there are.</li>
                            <li><strong>Median:</strong> Sort the numbers from smallest to largest. If there's an odd number of values, the median is the one in the middle. If there's an even number, the median is the average of the two middle numbers.</li>
                            <li><strong>Mode:</strong> Count how many times each number appears. The number that appears most often is the mode.</li>
                       </ul>
                    </AccordionContent>
                </AccordionItem>
