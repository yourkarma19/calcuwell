      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              The amount saved is calculated by multiplying the original price
              by the discount percentage (in decimal form). The final price is
              then found by subtracting the saved amount from the original
              price. For example, for a ₹100 item with a 20% discount, you save
              ₹20 (100 * 0.20), and the final price is ₹80 (100 - 20).
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              typically applied to the pre-tax price of an item. Sales tax, if
              applicable, would be calculated on the final discounted price.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
