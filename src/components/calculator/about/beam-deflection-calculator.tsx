    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          point load. A cantilever beam is one that is supported only at one
          end. This calculation is crucial for structural engineers to ensure
          that a beam can safely support its intended load without bending
          excessively.
        </p>
        ...
        <ol>
          <li>
            Enter the <strong>Load (P)</strong> in Newtons that is being applied
            to the very end of the beam.
          </li>
          <li>
        ...
        <p>
          The calculator will instantly compute the maximum deflection at the
          end of the beam.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Understanding beam deflection is critical in structural
              engineering for safety and functionality. Excessive deflection can
              lead to structural failure, damage to attached finishes (like
              drywall or windows), or create an unstable feeling in a building.
              Engineers use this calculation to select the appropriate beam size
              and material for a given span and load.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
