      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>
              How does this calculator show the results?
            </AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              The calculation measures the number of full calendar days between
              the start and end dates. For instance, the difference between
              January 1st and January 3rd is two full days. It does not count
              the start date in the total.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionTrigger>Does it account for leap years?</AccordionTrigger>
            <AccordionContent>
              Yes, the calculator accurately handles leap years in its
              calculations. This ensures the total number of days is correct
              even when the time period includes a leap day (February 29th).
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
