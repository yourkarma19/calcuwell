...
export const metadata: Metadata = {
  ...
  description: 'Explore articles and insights from the CalcPro team. We break down complex topics related to our calculators, from math concepts to financial planning.',
  alternates: {
    canonical: '/blog',
  },
};
