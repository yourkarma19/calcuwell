...
export default function InterceptCalculator() {
  const [form, setForm] = usePersistentState<EquationForm>(
    "intercept-form",
    "slope-intercept",
  );
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select the form of your linear equation and enter the values.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="slope-intercept">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm font-mono bg-gray-100 dark:bg-gray-800 p-2 rounded-md">
                  {steps.yIntercept}
                </p>
              </div>
              <div>
