            ...
            <CardContent className="prose dark:prose-invert max-w-none">
                ...
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                            This tool uses the international IANA Time Zone Database, which is maintained and updated with the correct Daylight Saving Time rules for each location. This ensures that the displayed times are accurate year-round, even when DST starts or ends.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                        <AccordionTrigger>What is a time zone?</AccordionTrigger>
                        <AccordionContent>
                           A time zone is a region of the globe that observes a uniform standard time for legal, commercial, and social purposes. For convenience, time zones tend to follow the boundaries of countries and their subdivisions. Most time zones are offset from Coordinated Universal Time (UTC) by a whole number of hours.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                        <AccordionTrigger>What is UTC?</AccordionTrigger>
                        <AccordionContent>
                            Coordinated Universal Time (UTC) is the primary time standard by which the world regulates clocks and time. It is not a time zone itself but rather the reference point from which all other time zones are calculated. It is the successor to Greenwich Mean Time (GMT).
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </CardContent>
