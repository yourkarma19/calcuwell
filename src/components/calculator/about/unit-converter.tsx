...
export default function AboutUnitConverter() {
  return (
    <Card>
      <CardHeader>
        <CardTitle as="h2">About the Unit Converter</CardTitle>
      </CardHeader>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              This calculator uses SI base units (like the meter) to perform
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              the world. The **Imperial system** is mainly used in the United
              States and includes units like feet, pounds, and gallons. This
              converter allows for easy translation between both systems.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
