  ...
  return (
    <>
      <div className="lg:col-span-2 space-y-6">
        ...
        <Card>
          <CardHeader><CardTitle>About Credit Card Debt</CardTitle></CardHeader>
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger>What is APR?</AccordionTrigger>
                <AccordionContent>
                  APR, or Annual Percentage Rate, is the yearly interest generated by a sum that's charged to borrowers or paid to investors. For credit cards, it's the interest rate for a whole year, rather than just a monthly fee/rate, applied to an account.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>Why does paying only the minimum take so long?</AccordionTrigger>
                <AccordionContent>
                  When you make only the minimum payment, a large portion of it goes towards paying the interest, with very little reducing the principal balance. This means your debt decreases very slowly, and you end up paying significantly more in interest over time.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
