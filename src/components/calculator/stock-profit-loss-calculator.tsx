      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
                <p>The Stock Profit & Loss Calculator is a vital tool for any investor. It gives you a clear and accurate picture of your trading performance. The tool calculates the net profit or loss from a specific trade. It includes key costs like brokerage commissions, so you can understand your true return on investment (ROI).</p>

                <h3>How to Use the Calculator</h3>
                <ol>
                    <li>Enter the Buy Price per Share.</li>
                    <li>Enter the Sell Price per Share.</li>
                    <li>Input the total Quantity of shares traded.</li>
                    <li>Provide the Buy and Sell Commission (brokerage fees).</li>
                </ol>
                ...
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                        <AccordionTrigger>How is total profit calculated?</AccordionTrigger>
                        <AccordionContent>
                            Total profit or loss is calculated by subtracting the total cost from the total proceeds. Total cost includes the price of the shares plus any buying fees. Total proceeds are the selling price minus any selling fees.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                        <AccordionTrigger>How do commissions affect my return?</AccordionTrigger>
                        <AccordionContent>
                            Commissions are fees charged by your broker for handling a trade. They are a direct cost of trading and reduce your overall profit. It is important to include them for an accurate picture of your actual return.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                        <AccordionTrigger>Does this calculator include taxes?</AccordionTrigger>
                        <AccordionContent>
                           No, this calculator does not include capital gains taxes. The profit shown is the gross profit before taxes. Tax rates on stock profits vary based on how long you hold the stock and your country's tax laws. You should consult a tax professional for specific advice.
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </CardContent>
