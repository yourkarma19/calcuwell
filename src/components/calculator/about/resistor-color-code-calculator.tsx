      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <ol>
          <li>
            ...
            on the right side. Read the colors from left to right.
          </li>
          <li>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              resistance value. The third band tells you what number to multiply
              those digits by (a power of 10). The last band shows the
              tolerance.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              A 5-band resistor adds a third digit for more precision. The first
              three bands are digits, the fourth is the multiplier, and the
              fifth is tolerance. A 6-band resistor adds a final band that
