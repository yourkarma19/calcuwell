    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          composition than weight or BMI alone. By estimating the amount of your
          body that is fat, it helps you track fitness and health progress more
          accurately. This tool uses the U.S. Navy method, a common formula
        ...
        <ol>
          ...
          <li>
            If you are female, also enter your <strong>Hip</strong> measurement.
          </li>
        </ol>
        <p>
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              special equipment. However, it&apos;s not as accurate as clinical
