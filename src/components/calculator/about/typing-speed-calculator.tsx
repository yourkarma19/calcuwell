    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          It&apos;s perfect for anyone looking to improve their typing skills,
          from students and administrative professionals to writers and
          developers. By practicing regularly, you can increase your speed and
          accuracy, boosting your productivity in any task that involves typing.
        </p>
        ...
        <ol>
          ...
          <li>
            Type the text as quickly and accurately as you can. Any errors will
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              higher is considered good for most professional roles that require
              significant typing. Professional typists and transcriptionists
              often achieve speeds well over 100 WPM, demonstrating exceptional
              skill.
            </AccordionContent>
          </AccordionItem>
