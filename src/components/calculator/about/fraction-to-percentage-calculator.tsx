    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p>
            This calculator provides a simple way to convert any fraction into
            its equivalent percentage. This is a fundamental math skill useful
            in various contexts, from interpreting statistics to understanding
          ...
          <p>
            First, the fraction is converted into a decimal by dividing the
            numerator by the denominator. Then, this decimal is multiplied by
