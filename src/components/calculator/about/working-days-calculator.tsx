    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          schedules accurately. It calculates the number of business days
          between two dates, automatically excluding weekends (Saturdays and
          Sundays) to give you a realistic timeline for work-related tasks.
        </p>
        ...
        <ol>
          <li>
            ...
            <strong>End Date</strong> using the calendars.
          </li>
          <li>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Calculating working days is crucial for accurate project planning,
              estimating delivery times, managing employee leave, and ensuring
              that contract deadlines are realistic. It removes the guesswork of
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              significantly by country and region, so they are not included in
              the calculation. For precise planning, you should manually
              subtract any public holidays that fall within your calculated date
              range.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              adds or subtracts a specific number of business days from a start
              date to find a future or past date. This Working Days Calculator,
              on the other hand, counts the total number of business days that
              fall between two given dates.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </CardContent>
