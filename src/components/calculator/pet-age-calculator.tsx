...
export default function PetAgeCalculator() {
  ...
  return (
    <div className="lg:col-span-3 space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle>About Pet Age Calculation</CardTitle></CardHeader>
        <CardContent>
            <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                       Yes, significantly. Smaller dog breeds tend to live longer and mature slower than large breeds. For example, a 7-year-old Great Dane is much "older" in human years than a 7-year-old Chihuahua. This calculator provides a general estimate, but breed-specific charts can offer more accuracy.
                    </AccordionContent>
                </AccordionItem>
