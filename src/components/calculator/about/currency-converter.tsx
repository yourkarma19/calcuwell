    ...
    return (
        <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
                ...
                <ol>
                    <li>Enter the <strong>Amount</strong> you wish to convert in the first field.</li>
                    <li>Select the currency you are converting <strong>from</strong>.</li>
                    <li>Select the currency you want to convert <strong>to</strong>.</li>
                </ol>
