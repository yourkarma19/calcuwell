    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        <p>
          ...
          tangent line represents the instantaneous rate of change of the
          function at that exact point. Understanding how to find it is a core
        ...
        <ol>
          ...
          <li>
            Enter the specific point `x` where you want to find the tangent
            line.
          </li>
          <li>Click &quot;Find Tangent Line&quot;.</li>
        </ol>
        <p>
          The tool will provide the equation of the tangent line in
          slope-intercept form (`y = mx + b`) and show the detailed steps to
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              curve at a single point and has the same direction as the curve at
              that point. The slope of the tangent line is equal to the
              derivative of the function evaluated at that same point.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              <ol>
                ...
                <li>
                  Find the y-coordinate of the point by calculating `f(a)`.
                </li>
                <li>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              derivatives. The derivative of a function gives its rate of
              change. The tangent line provides a linear approximation of the
