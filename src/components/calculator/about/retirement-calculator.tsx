...
export default function AboutRetirementCalculator() {
  return (
    <Card>
      <CardHeader>
        <CardTitle as="h2">About the Retirement Calculator</CardTitle>
      </CardHeader>
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        />
        <p>
          The <strong>Retirement Calculator</strong> helps you estimate if you
          are on track to meet your long-term savings goals. By inputting your
          current age, savings, and contributions, you can get a clear
          projection of your financial future. This allows you to make informed
          decisions today for a secure retirement.
        </p>

        <h3>How to Use the Retirement Calculator</h3>
        <ol>
          <li>
            Enter your <strong>Current Age</strong> and desired{" "}
            <strong>Retirement Age</strong>.
          </li>
          <li>
            Input your <strong>Current Savings</strong> and your monthly
            <strong>Contribution</strong>.
          </li>
          <li>
            Adjust the estimated <strong>Annual Interest Rate</strong>.
          </li>
          <li>
            Set your <strong>Desired Annual Retirement Income</strong>.
          </li>
        </ol>
        <p>
          The calculator will show your projected savings, your savings goal,
          and whether you are on track to meet it.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Starting early is powerful because of compound interest. The
              longer your money is invested, the more time it has to grow. Even
              small, regular contributions can grow into a large sum over many
              decades.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              required savings goal. If this calculator shows a shortfall, you
              may need to increase your contributions or adjust your goals.
            </AccordionContent>
          </AccordionItem>
